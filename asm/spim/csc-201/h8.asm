...
#       NAME: 
#       DATE: June 13, 2001
# ASSIGNMENT: Homework #8, CSC-201-01
...
#             numbers given. Also find the average.
#
# =========================================================================
...
prompt5: .asciiz "The number of integers entered is "
newline: .asciiz "\n"
...
# =========================================================================
	...
	la	$a0, prompt4
	li	$v0, 4
	syscall				# print "The average is ... "

	div	$a0, $t1, $t0		# $a0 = sum / counter
	li	$v0, 1
