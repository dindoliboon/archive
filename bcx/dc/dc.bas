...
'   � Dialog Converter v1.3  ( Original by DL ) Updated by Kevin Diggins �
'   쳐컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴캑
'   � Converts Microsoft Dialog Editor scripts to BCX BASIC source code. �
'   � dc [drive:][path]filename[.dlg] [/m] [/s] [/c] [/?]                �
'   쳐컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴캑
'   � [drive:][path]filename[.dlg]                                       �
'   � Specifies the file that you would like to convert.                 �
'   � The drive, path, and dlg extention are optional.                   �
'   쳐컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴캑
'   � /m Adds menu-system to source code.                                �
'   � /s Displays status while converting scripts.                       �
'   � /c Adds control subclass to source code.                           �
'   � /? Displays meanings of arguments.                                 �
...
szTempA$ = TRIM$(parse$(COMMAND$, "/", 0))   ' get file name
...
FPRINT FPout, "'                 For Use With BCX Translator Version 2.02+"
EmitSeparator (FPout)
FPRINT FPout, ""
...
FPRINT FPout, " IF NOT IsWindow( GetActiveWindow() ) OR _"
FPRINT FPout, "    NOT IsDialogMessage( GetActiveWindow(), &Msg ) THEN"
...
' the string is not found
  ...
  IF MOD(TALLY(szTempA$, Chr$(34)),2) <> 0 THEN
